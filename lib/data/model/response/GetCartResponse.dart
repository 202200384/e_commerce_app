...
class GetProductCart {
  ...
  GetProductCart.fromJson(dynamic json) {
    count = json['count'];
    id = json['_id'];
    product = json['product'] != null ? GetProduct.fromJson(json['product']) : null;
    price = json['price'];
  }
  num? count;
  String? id;
...
class GetProduct {
  ...
  GetProduct.fromJson(dynamic json) {
    ...
    category = json['category'] != null ? CategoryOrBrand.fromJson(json['category']) : null;
    brand = json['brand'] != null ? CategoryOrBrand.fromJson(json['brand']) : null;
